...
import flogo4 from "../../images/funderlogo4.png"
...
const Funders = () => {
  ...
  const logo_array = [
    ...
    { img: flogo3, expand: "30%", alt: "Inspirit Logo" },
    { img: flogo7, expand: "50%", alt: "RBC Logo" },

    { img: flogo6, expand: "30%", alt: "KW Community Foundation Logo" },
